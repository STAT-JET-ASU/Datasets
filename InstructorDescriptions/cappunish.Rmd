...
<i class="fas fa-database"></i> [`cappunish20220512.csv`](https://raw.githubusercontent.com/STAT-JET-ASU/Datasets/master/Instructor/cappunish20220512.csv)
...
<i class="fas fa-database"></i> [`executions19762021.csv`](https://raw.githubusercontent.com/STAT-JET-ASU/Datasets/master/Instructor/executions1976to2021.csv)
...
Data about the death penalty in the United States as of May 12, 2022.
...
```{r}
DATA <- read_csv("https://raw.githubusercontent.com/STAT-JET-ASU/Datasets/master/Instructor/cappunish20220512.csv")
glimpse(DATA)
head(DATA)
```
...
Number of prisoners on death row for each year from 1968 to 2021.
...
* `yxxxx`: year (number of executions for each year from 1976 to 2021)

```{r}
DATA <- read_csv("https://raw.githubusercontent.com/STAT-JET-ASU/Datasets/master/Instructor/executions1976to2021.csv")
glimpse(DATA)
head(DATA)
```
