...
* total_days: number of says canceled for the school year
* total_snow: total inches of snow during the school year

```{r, echo=FALSE, message=FALSE}
library(dplyr)
DATA <- read.csv("https://raw.githubusercontent.com/STAT-JET-ASU/Datasets/master/Instructor/wcsweatherdays.csv")
glimpse(DATA)
```
